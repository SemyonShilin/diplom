...
class CubicParabolaWithExtremes
  ...
  def determinant_a
    Matrix[[sum(x_in_degree_n_on_y) - y.first*sum(x_in_degree_n(1)), sum(x_in_degree_n(3)), sum(x_in_degree_n)],
           ...
           [sum(x_in_degree_n_on_y(3)) - y.first*sum(x_in_degree_n(3)), sum(x_in_degree_n(5)), sum(x_in_degree_n(4))]].det
  end
  ...
  def determinant_b
    Matrix[[sum(x_in_degree_n(4)), sum(x_in_degree_n_on_y) - y.first*sum(x_in_degree_n(1)), sum(x_in_degree_n)],
           ...
           [sum(x_in_degree_n(6)), sum(x_in_degree_n_on_y(3)) - y.first*sum(x_in_degree_n(3)), sum(x_in_degree_n(4))]].det
  end
  ...
  def determinant_c
    Matrix[[sum(x_in_degree_n(4)), sum(x_in_degree_n(3)), sum(x_in_degree_n_on_y) - y.first*sum(x_in_degree_n(1))],
           ...
           [sum(x_in_degree_n(6)), sum(x_in_degree_n(5)), sum(x_in_degree_n_on_y(3)) - y.first*sum(x_in_degree_n(3))]].det
  end
end
